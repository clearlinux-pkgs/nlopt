...
Source0  : https://github.com/stevengj/nlopt/archive/v2.9.0/nlopt-2.9.0.tar.gz
...
%prep
%setup -q -n nlopt-2.9.0
cd %{_builddir}/nlopt-2.9.0
pushd ..
cp -a nlopt-2.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731434589
mkdir -p clr-build
pushd clr-build
...
%files
%defattr(-,root,root,-)
/V3/usr/lib64/octave/9.2.0/site/oct/x86_64-generic-linux-gnu/nlopt_optimize.oct
/usr/lib64/octave/9.2.0/site/oct/x86_64-generic-linux-gnu/nlopt_optimize.oct
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libnlopt.so.0.13.0
/usr/lib64/libnlopt.so.0
/usr/lib64/libnlopt.so.0.13.0
