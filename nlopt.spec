...
%prep
%setup -q -n nlopt-2.8.0
cd %{_builddir}/nlopt-2.8.0
pushd ..
cp -a nlopt-2.8.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1723477289
mkdir -p clr-build
pushd clr-build
...
/usr/share/octave/9.2.0/site/m/NLOPT_LD_LBFGS_NOCEDAL.m
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libnlopt.so.0.12.0
/usr/lib64/libnlopt.so.0
/usr/lib64/libnlopt.so.0.12.0
